...
public class StringHelper {
	 ...
	 * @return true if s is null or contains just whitespace characters, false otherwise
	 */
	...
	public static class TextInsert {
		...
		/**
		 * Constructor of TextInsert.
		 * @param startIndex the index to where the text is inserted to
		 * @param insertedText the inserted string
		 */
